...
| `Docs/requirements.md` | `/generate-requirements` | User stories, acceptance criteria, use cases |
...
# → Creates Context/Docs/requirements.md with acceptance criteria

# 3. Break down into executable tasks
/generate-task Context/Docs/requirements.md
# → Creates Context/Tasks/<markdown files for each of the task>

# 4. Generate comprehensive tests
/generate-automation-test Context/Docs/requirements.md
...
# → Generates comprehensive user stories in Context/Docs/requirements.md
```
...
/generate-design Context/Docs/requirements.md
# → Context/design.md
...
| `/generate-requirements` | Create structured requirements | Specifications, user stories | `Context/Docs/requirements.md` |
...
# → Context/Docs/requirements.md with modernization user stories
