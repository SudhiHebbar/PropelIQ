...
**Accepts:** Test workflow file path | .propel/context/tests directory scan | Specific workflow name | Empty (auto-detect)
...
- **Workflow Specifications**: Read test workflow files from .propel/context/tests directory
