...
1. `/generate-automation-test Context/Docs/requirements.md` → Creates workflow files in Context/Test/
...
- **Best For**: Processing all workflows after running `/generate-automation-test Context/Docs/requirements.md`
